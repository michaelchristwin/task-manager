  ...
  return (
    <div class={styles.App}>
      ...
      >
        ...
        <p class={`text-white text-[18px] font-[500]`}>
        ...
        >
          <A
            href="/tasks"
            class={`bg-primary w-[150px] hover:opacity-[0.9] h-[50px] flex justify-center items-center text-black rounded-md font-[600]`}
          >
            Try Now
          </A>
          <button
            class={`bg-white w-[150px] hover:opacity-[0.9] h-[50px] flex justify-center items-center text-black rounded-md font-[600]`}
          >
            Sign Up
          </button>
        </div>
